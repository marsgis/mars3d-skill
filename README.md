...
```powershell
cd E:\your-mars3d-project
New-Item -ItemType Directory -Force .agents\skills\mars3d-skill | Out-Null
Copy-Item -Recurse -Force E:\temp\mars3d-skill\mars3d-skill\* .agents\skills\mars3d-skill\
```
